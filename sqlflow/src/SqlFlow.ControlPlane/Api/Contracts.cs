...
/// that counts only as far as a bound (a contributed search category over a large store, say) sets
/// <c>TotalCapped</c>, and its total is then a floor: that many match, and more.</summary>

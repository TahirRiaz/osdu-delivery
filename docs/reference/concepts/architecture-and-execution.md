...
- **Source readers:** `CsvSourceReader`, `XlsSourceReader`, `JsonSourceReader`, `XmlSourceReader`, `ParquetSourceReader`, `DuckDbSourceReader`, plus `LocalFileStore` and `LocalFileLifecycle`.

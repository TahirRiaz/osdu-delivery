...
| --- | --- | --- | --- | --- |
| `FileName_DW` | nvarchar(4000) | File name; the full path when `showPathWithFileName: "true"` | `includeFileName` | `true` |

...
Status: the Well Delivery, RAFS, Seismic Store and production historian shapes are built; the rest of the table is
built in the order it is listed, each with its fake service, its contract checks and its documentation.

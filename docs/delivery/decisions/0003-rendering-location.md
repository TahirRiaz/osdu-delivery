...
Either works; the snapshots are direction-neutral. The choice decides whether the translate renderer is
...
- The reference cache moves out of petrodb-api's per-replica memory into a versioned snapshot the render
  context records.

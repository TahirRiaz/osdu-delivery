...
public sealed class YamlInvokeFlowLoaderTests
{
    ...
    public void DocumentLoader_DispatchesInv_AndNamesItInTheUnknownKindError()
    {
        var documents = new YamlDocumentLoader(
            ...
            new YamlStoredProcedureFlowLoader(), new YamlInvokeFlowLoader(), new YamlHealthCheckFlowLoader(), new YamlSourceControlFlowLoader(), new YamlBatchFlowLoader(), new YamlAcquireFlowLoader(), new YamlCopyFlowLoader(), new YamlSftpFlowLoader());
